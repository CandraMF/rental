                ...
                <form method="post" action="{{ route('petugas.member.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div class="cols-span-1">
                            ...
                            <x-text-input id="no_ktp" name="no_ktp" type="text" class="mt-1 block w-full" autocomplete="no_ktp" />
                            <x-input-error :messages="$errors->get('no_ktp')" class="mt-2" />
                        </div>
                        <div class="cols-span-1">
                            <x-input-label for="no_sim" :value="__('Nomor SIM')" />
                            <x-text-input id="no_sim" name="no_sim" type="text" class="mt-1 block w-full" autocomplete="no_sim" />
