                    ...
                    <table class=" w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-6 py-4 w-44">
                                    <span class="text-black">Rp. {{ number_format($penyewaan->pengembalian->sisa_bayar + $penyewaan->pengembalian->denda) }} <br></span>
